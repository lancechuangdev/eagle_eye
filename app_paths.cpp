...
const std::filesystem::path AppPaths::Detection_Reports_Path = AppPaths::getHomePath() / "eagle_eye" / "detection_reports";
...
{
    return AppPaths::getHomePath() / "eagle_eye" / "detection_projects" / project_name / "detection_results";
}